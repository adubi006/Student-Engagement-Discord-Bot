# Student Engagement Discord Bot

## Project description

- *We are to develop an interactive Discord Bot for a student Discord server. The primary purpose of this bot is to actively engage students on a weekly basis by presenting well-organized questions sourced from Google Spreadsheet. The bot will routinely deliver 2-3 questions per week. The bot will routinely deliver 2-3 questions per week, collect and store responses within Google Spreadsheet. Additionally, the accumulated data will undergo analysis and visualization, potentially using Looker Studio, to offer valuable insights and support decision-making processes.*
  
- *Notion Page Link:- https://www.notion.so/explore-ai/Student-Engagement-Discord-Bot*

## Team Members

- Grace Bidemi
- Reamogetse Ramatsetse
- Ireoluwa Ige
- Tioluwatise Onadipe
- Olanike Salami
- Brighton Moyo
